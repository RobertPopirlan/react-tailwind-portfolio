  ...
  return (
    ...
    <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
      <div className='flex flex-col justify-center h-full'>
        ...
        <p className='text-gray-500 py-4 max-w-md'> I do not have any experience yet</p>
      <div>
      ...
      <div className='rounded-full bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-green-300 via-blue-500 to-purple-600 overflow-hidden'>
